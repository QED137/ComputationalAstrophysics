...
2. Clone this repository: `git clone https://github.com/your-username/kepler-equation-solver.git`
3. Navigate to the repository: `cd kepler-equation-solver`
4. Run the script: `python kepler_solver.py`
